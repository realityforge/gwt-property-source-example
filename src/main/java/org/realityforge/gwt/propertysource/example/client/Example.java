  ...
  implements EntryPoint
{
  ...
  {
    final MyDynamicPropertySource dynamicSource = GWT.create( MyDynamicPropertySource.class );
    final MyStaticPropertySource staticSource = GWT.create( MyStaticPropertySource.class );
    ...
    html += "Multi conf reversed: " + dynamicSource.multiConfigReversed() + "<br />";
    html += "System properties: " + dynamicSource.readSystemProperties() + "<br />";

    html += "<h1>Static properties</h1>";
    html += "String: " + staticSource.string() + "<br />";
    html += "User agent: " + staticSource.userAgent() + "<br />";
    html += "Open source engine: " + staticSource.isOpenSourceEngine() + "<br />";
    ...
    html += "Multi conf contains 1 or 2: " + staticSource.multiContains1or2() + "<br />";
    html += "Multi conf contains 1 and 2: " + staticSource.multiContains1and2() + "<br />";
