...
desc 'A simple application demonstrating the use of the gwt-propertysource library'
define 'gwt-property-source-example' do
  ...
  iml.add_gwt_facet({'org.realityforge.gwt.propertysource.example.Example' => true},
